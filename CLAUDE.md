...
- **Not yet done** (per the 2nd design law): homepage Live-Demo embed + tabbed category deep-dive; calculator-page sticky sidebar; Playwright E2E; a real Lighthouse run (budgets are met per build output, but Lighthouse itself hasn't been run).
