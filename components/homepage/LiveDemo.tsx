...
const POINTS = [
  {
    icon: "Zap",
    title: "No page reloads, ever",
    body: "The math runs in your browser. Change a number and the answer updates on the same frame.",
  },
  {
    icon: "ShieldCheck",
    title: "The same engine everywhere",
    body: "This embedded tool is the exact calculator you get on its own page — one tested engine, 50+ calculators.",
  },
  {
    icon: "Gauge",
    title: "Nothing between you and the answer",
    body: "No sign-up wall, no pop-ups, no ads wedged between the input and the result.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div>
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl font-bold tracking-tight text-text-primary">
              Don&apos;t take our word for it. Use one.
            </h2>
            <p className="mt-4 text-lg text-text-secondary max-w-md">
              This is a fully working calculator, running right here on the
              homepage. Type a percentage and a value — the result appears
              instantly, exactly as it would on its own page.
            </p>
          ...
          <div className="lg:justify-self-end w-full max-w-calc">
            <CalculatorShell definition={percent} />
          </div>
        </div>
      </div>
    </section>
