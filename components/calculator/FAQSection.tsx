...
export function FAQSection({ definition }: { definition: CalculatorDefinition }) {
  if (!definition.faqs.length) return null;

  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: definition.faqs.map((f) => ({
      "@type": "Question",
      name: f.question,
