...
export const UI = {
  es: {
    ...
    reviewNote: "Revisamos todas nuestras herramientas de vez en cuando para garantizar su precisión.",
    share: "Compartir",
  ...
  en: {
    ...
    reviewNote: "We review all our tools from time to time to ensure accuracy.",
    share: "Share",
    copyLink: "Copy link",
    copied: "Copied",
    print: "Print",
